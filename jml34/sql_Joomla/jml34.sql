...
-- Tiempo de generación: 30-11-2020 a las 11:03:53
...
--
-- Estructura de tabla para la tabla `odvc6_action_logs`
--

CREATE TABLE IF NOT EXISTS `odvc6_action_logs` (
...
--
-- Volcado de datos para la tabla `odvc6_action_logs`
--

INSERT INTO `odvc6_action_logs` (`id`, `message_language_key`, `message`, `log_date`, `extension`, `user_id`, `item_id`, `ip_address`) VALUES
(1, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{"action":"login","userid":"842","username":"root","accountlink":"index.php?option=com_users&task=user.edit&id=842","app":"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR"}', '2020-11-30 09:59:30', 'com_users', 842, 0, 'COM_ACTIONLOGS_DISABLED'),
(2, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{"action":"login","userid":"842","username":"root","accountlink":"index.php?option=com_users&task=user.edit&id=842","app":"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE"}', '2020-11-30 09:59:39', 'com_users', 842, 0, 'COM_ACTIONLOGS_DISABLED');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `odvc6_action_logs_extensions`
--

CREATE TABLE IF NOT EXISTS `odvc6_action_logs_extensions` (
  `id` int(10) unsigned NOT NULL,
  `extension` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `odvc6_action_logs_extensions`
--

INSERT INTO `odvc6_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Estructura de tabla para la tabla `odvc6_action_logs_users`
--

CREATE TABLE IF NOT EXISTS `odvc6_action_logs_users` (
...
--
-- Estructura de tabla para la tabla `odvc6_action_log_config`
--

CREATE TABLE IF NOT EXISTS `odvc6_action_log_config` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Volcado de datos para la tabla `odvc6_action_log_config`
--

INSERT INTO `odvc6_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Estructura de tabla para la tabla `odvc6_assets`
--

CREATE TABLE IF NOT EXISTS `odvc6_assets` (
...
--
-- Volcado de datos para la tabla `odvc6_assets`
--

INSERT INTO `odvc6_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Estructura de tabla para la tabla `odvc6_associations`
--

CREATE TABLE IF NOT EXISTS `odvc6_associations` (
...
--
-- Estructura de tabla para la tabla `odvc6_banners`
--

CREATE TABLE IF NOT EXISTS `odvc6_banners` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `odvc6_banner_clients`
--

CREATE TABLE IF NOT EXISTS `odvc6_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `odvc6_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `odvc6_banner_tracks` (
...
--
-- Estructura de tabla para la tabla `odvc6_categories`
--

CREATE TABLE IF NOT EXISTS `odvc6_categories` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `odvc6_categories`
--

INSERT INTO `odvc6_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 842, '2020-11-30 09:59:04', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 842, '2020-11-30 09:59:04', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 842, '2020-11-30 09:59:04', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 842, '2020-11-30 09:59:04', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 842, '2020-11-30 09:59:04', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 842, '2020-11-30 09:59:04', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `odvc6_contact_details`
--

CREATE TABLE IF NOT EXISTS `odvc6_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `odvc6_content`
--

CREATE TABLE IF NOT EXISTS `odvc6_content` (
  `id` int(10) unsigned NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `odvc6_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `odvc6_contentitem_tag_map` (
  `type_alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `odvc6_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `odvc6_content_frontpage` (
...
--
-- Estructura de tabla para la tabla `odvc6_content_rating`
--

CREATE TABLE IF NOT EXISTS `odvc6_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `odvc6_content_types`
--

CREATE TABLE IF NOT EXISTS `odvc6_content_types` (
...
--
-- Volcado de datos para la tabla `odvc6_content_types`
--

INSERT INTO `odvc6_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Estructura de tabla para la tabla `odvc6_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `odvc6_core_log_searches` (
...
--
-- Estructura de tabla para la tabla `odvc6_extensions`
--

CREATE TABLE IF NOT EXISTS `odvc6_extensions` (
...
--
-- Volcado de datos para la tabla `odvc6_extensions`
--

INSERT INTO `odvc6_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"6796be2669c853e9b5e7f4987682f911"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1606730360}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Estructura de tabla para la tabla `odvc6_fields`
--

CREATE TABLE IF NOT EXISTS `odvc6_fields` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `odvc6_fields_categories`
--

CREATE TABLE IF NOT EXISTS `odvc6_fields_categories` (
...
--
-- Estructura de tabla para la tabla `odvc6_fields_groups`
--

CREATE TABLE IF NOT EXISTS `odvc6_fields_groups` (
  `id` int(10) unsigned NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `odvc6_fields_values`
--

CREATE TABLE IF NOT EXISTS `odvc6_fields_values` (
...
--
-- Estructura de tabla para la tabla `odvc6_finder_filters`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_filters` (
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links` (
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `odvc6_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `odvc6_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Volcado de datos para la tabla `odvc6_finder_taxonomy`
--

INSERT INTO `odvc6_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `odvc6_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `odvc6_finder_terms`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_terms` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `odvc6_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `odvc6_finder_terms_common`
--

INSERT INTO `odvc6_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Estructura de tabla para la tabla `odvc6_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `odvc6_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `odvc6_finder_types`
--

CREATE TABLE IF NOT EXISTS `odvc6_finder_types` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `odvc6_languages`
--

CREATE TABLE IF NOT EXISTS `odvc6_languages` (
...
--
-- Volcado de datos para la tabla `odvc6_languages`
--

INSERT INTO `odvc6_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `odvc6_menu`
--

CREATE TABLE IF NOT EXISTS `odvc6_menu` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `odvc6_menu`
--

INSERT INTO `odvc6_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Estructura de tabla para la tabla `odvc6_menu_types`
--

CREATE TABLE IF NOT EXISTS `odvc6_menu_types` (
  `id` int(10) unsigned NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `odvc6_menu_types`
--

INSERT INTO `odvc6_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `odvc6_messages`
--

CREATE TABLE IF NOT EXISTS `odvc6_messages` (
...
--
-- Estructura de tabla para la tabla `odvc6_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `odvc6_messages_cfg` (
...
--
-- Estructura de tabla para la tabla `odvc6_modules`
--

CREATE TABLE IF NOT EXISTS `odvc6_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Volcado de datos para la tabla `odvc6_modules`
--

INSERT INTO `odvc6_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Estructura de tabla para la tabla `odvc6_modules_menu`
--

CREATE TABLE IF NOT EXISTS `odvc6_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `odvc6_modules_menu`
--

INSERT INTO `odvc6_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `odvc6_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `odvc6_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `odvc6_overrider`
--

CREATE TABLE IF NOT EXISTS `odvc6_overrider` (
...
--
-- Estructura de tabla para la tabla `odvc6_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `odvc6_postinstall_messages` (
...
--
-- Volcado de datos para la tabla `odvc6_postinstall_messages`
--

INSERT INTO `odvc6_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Estructura de tabla para la tabla `odvc6_privacy_consents`
--

CREATE TABLE IF NOT EXISTS `odvc6_privacy_consents` (
  `id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `odvc6_privacy_requests`
--

CREATE TABLE IF NOT EXISTS `odvc6_privacy_requests` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `odvc6_redirect_links`
--

CREATE TABLE IF NOT EXISTS `odvc6_redirect_links` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `odvc6_schemas`
--

CREATE TABLE IF NOT EXISTS `odvc6_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `odvc6_schemas`
--

INSERT INTO `odvc6_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.9.22-2020-09-16');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `odvc6_session`
--

CREATE TABLE IF NOT EXISTS `odvc6_session` (
...
--
-- Volcado de datos para la tabla `odvc6_session`
--

INSERT INTO `odvc6_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x64766f6465343639356776667435756d65377337706935633975696b37327630, 1, 0, 1606730373, 'joomla|s:868:"";', 842, 'root'),
(0x65316875646e6f327432376975387372646d636d7139666a6973306336766437, 0, 0, 1606730380, 'joomla|s:968:"";', 842, 'root');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `odvc6_tags`
--

CREATE TABLE IF NOT EXISTS `odvc6_tags` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `odvc6_tags`
--

INSERT INTO `odvc6_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 842, '2020-11-30 09:59:04', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `odvc6_template_styles`
--

CREATE TABLE IF NOT EXISTS `odvc6_template_styles` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Volcado de datos para la tabla `odvc6_template_styles`
--

INSERT INTO `odvc6_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Estructura de tabla para la tabla `odvc6_ucm_base`
--

CREATE TABLE IF NOT EXISTS `odvc6_ucm_base` (
...
--
-- Estructura de tabla para la tabla `odvc6_ucm_content`
--

CREATE TABLE IF NOT EXISTS `odvc6_ucm_content` (
...
--
-- Estructura de tabla para la tabla `odvc6_ucm_history`
--

CREATE TABLE IF NOT EXISTS `odvc6_ucm_history` (
...
--
-- Estructura de tabla para la tabla `odvc6_updates`
--

CREATE TABLE IF NOT EXISTS `odvc6_updates` (
...
--
-- Volcado de datos para la tabla `odvc6_updates`
--

INSERT INTO `odvc6_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
(46, 2, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/uk-UA_details.xml', '', ''),
...
--
-- Estructura de tabla para la tabla `odvc6_update_sites`
--

CREATE TABLE IF NOT EXISTS `odvc6_update_sites` (
...
--
-- Volcado de datos para la tabla `odvc6_update_sites`
--

INSERT INTO `odvc6_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1606730360, ''),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1606730372, ''),
(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1606730372, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `odvc6_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `odvc6_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Volcado de datos para la tabla `odvc6_update_sites_extensions`
--

INSERT INTO `odvc6_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 802),
(3, 28);
...
--
-- Estructura de tabla para la tabla `odvc6_usergroups`
--

CREATE TABLE IF NOT EXISTS `odvc6_usergroups` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
...
--
-- Volcado de datos para la tabla `odvc6_usergroups`
--

INSERT INTO `odvc6_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Estructura de tabla para la tabla `odvc6_users`
--

CREATE TABLE IF NOT EXISTS `odvc6_users` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `odvc6_users`
--

INSERT INTO `odvc6_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(842, 'Super User', 'root', 'ramon1997_@hotmail.es', '$2y$10$55TLKp/BMDYyHmLyibmGo.i1MN7VoKxQWIKYp06VIDTm8QBEyldDa', 0, 1, '2020-11-30 09:59:04', '2020-11-30 09:59:39', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `odvc6_user_keys`
--

CREATE TABLE IF NOT EXISTS `odvc6_user_keys` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `odvc6_user_notes`
--

CREATE TABLE IF NOT EXISTS `odvc6_user_notes` (
  `id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `odvc6_user_profiles`
--

CREATE TABLE IF NOT EXISTS `odvc6_user_profiles` (
...
--
-- Estructura de tabla para la tabla `odvc6_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `odvc6_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `odvc6_user_usergroup_map`
--

INSERT INTO `odvc6_user_usergroup_map` (`user_id`, `group_id`) VALUES
(842, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `odvc6_utf8_conversion`
--

CREATE TABLE IF NOT EXISTS `odvc6_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `odvc6_utf8_conversion`
--

INSERT INTO `odvc6_utf8_conversion` (`converted`) VALUES
(5);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `odvc6_viewlevels`
--

CREATE TABLE IF NOT EXISTS `odvc6_viewlevels` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Volcado de datos para la tabla `odvc6_viewlevels`
--

INSERT INTO `odvc6_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indices de la tabla `odvc6_action_logs`
--
ALTER TABLE `odvc6_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `odvc6_action_logs_extensions`
--
ALTER TABLE `odvc6_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `odvc6_action_logs_users`
--
ALTER TABLE `odvc6_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Indices de la tabla `odvc6_action_log_config`
--
ALTER TABLE `odvc6_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `odvc6_assets`
--
ALTER TABLE `odvc6_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `odvc6_associations`
--
ALTER TABLE `odvc6_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indices de la tabla `odvc6_banners`
--
ALTER TABLE `odvc6_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `odvc6_banner_clients`
--
ALTER TABLE `odvc6_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indices de la tabla `odvc6_banner_tracks`
--
ALTER TABLE `odvc6_banner_tracks`
...
--
-- Indices de la tabla `odvc6_categories`
--
ALTER TABLE `odvc6_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `odvc6_contact_details`
--
ALTER TABLE `odvc6_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indices de la tabla `odvc6_content`
--
ALTER TABLE `odvc6_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `odvc6_contentitem_tag_map`
--
ALTER TABLE `odvc6_contentitem_tag_map`
...
--
-- Indices de la tabla `odvc6_content_frontpage`
--
ALTER TABLE `odvc6_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `odvc6_content_rating`
--
ALTER TABLE `odvc6_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `odvc6_content_types`
--
ALTER TABLE `odvc6_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indices de la tabla `odvc6_extensions`
--
ALTER TABLE `odvc6_extensions`
...
--
-- Indices de la tabla `odvc6_fields`
--
ALTER TABLE `odvc6_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `odvc6_fields_categories`
--
ALTER TABLE `odvc6_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Indices de la tabla `odvc6_fields_groups`
--
ALTER TABLE `odvc6_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `odvc6_fields_values`
--
ALTER TABLE `odvc6_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Indices de la tabla `odvc6_finder_filters`
--
ALTER TABLE `odvc6_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indices de la tabla `odvc6_finder_links`
--
ALTER TABLE `odvc6_finder_links`
...
--
-- Indices de la tabla `odvc6_finder_links_terms0`
--
ALTER TABLE `odvc6_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `odvc6_finder_links_terms1`
--
ALTER TABLE `odvc6_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `odvc6_finder_links_terms2`
--
ALTER TABLE `odvc6_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `odvc6_finder_links_terms3`
--
ALTER TABLE `odvc6_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `odvc6_finder_links_terms4`
--
ALTER TABLE `odvc6_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `odvc6_finder_links_terms5`
--
ALTER TABLE `odvc6_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `odvc6_finder_links_terms6`
--
ALTER TABLE `odvc6_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `odvc6_finder_links_terms7`
--
ALTER TABLE `odvc6_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `odvc6_finder_links_terms8`
--
ALTER TABLE `odvc6_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `odvc6_finder_links_terms9`
--
ALTER TABLE `odvc6_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `odvc6_finder_links_termsa`
--
ALTER TABLE `odvc6_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `odvc6_finder_links_termsb`
--
ALTER TABLE `odvc6_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `odvc6_finder_links_termsc`
--
ALTER TABLE `odvc6_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `odvc6_finder_links_termsd`
--
ALTER TABLE `odvc6_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `odvc6_finder_links_termse`
--
ALTER TABLE `odvc6_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `odvc6_finder_links_termsf`
--
ALTER TABLE `odvc6_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `odvc6_finder_taxonomy`
--
ALTER TABLE `odvc6_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `odvc6_finder_taxonomy_map`
--
ALTER TABLE `odvc6_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indices de la tabla `odvc6_finder_terms`
--
ALTER TABLE `odvc6_finder_terms`
...
--
-- Indices de la tabla `odvc6_finder_terms_common`
--
ALTER TABLE `odvc6_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indices de la tabla `odvc6_finder_tokens`
--
ALTER TABLE `odvc6_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indices de la tabla `odvc6_finder_tokens_aggregate`
--
ALTER TABLE `odvc6_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indices de la tabla `odvc6_finder_types`
--
ALTER TABLE `odvc6_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indices de la tabla `odvc6_languages`
--
ALTER TABLE `odvc6_languages`
...
--
-- Indices de la tabla `odvc6_menu`
--
ALTER TABLE `odvc6_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `odvc6_menu_types`
--
ALTER TABLE `odvc6_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indices de la tabla `odvc6_messages`
--
ALTER TABLE `odvc6_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indices de la tabla `odvc6_messages_cfg`
--
ALTER TABLE `odvc6_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indices de la tabla `odvc6_modules`
--
ALTER TABLE `odvc6_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `odvc6_modules_menu`
--
ALTER TABLE `odvc6_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indices de la tabla `odvc6_newsfeeds`
--
ALTER TABLE `odvc6_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indices de la tabla `odvc6_overrider`
--
ALTER TABLE `odvc6_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `odvc6_postinstall_messages`
--
ALTER TABLE `odvc6_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indices de la tabla `odvc6_privacy_consents`
--
ALTER TABLE `odvc6_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Indices de la tabla `odvc6_privacy_requests`
--
ALTER TABLE `odvc6_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `odvc6_redirect_links`
--
ALTER TABLE `odvc6_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indices de la tabla `odvc6_schemas`
--
ALTER TABLE `odvc6_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indices de la tabla `odvc6_session`
--
ALTER TABLE `odvc6_session`
...
--
-- Indices de la tabla `odvc6_tags`
--
ALTER TABLE `odvc6_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `odvc6_template_styles`
--
ALTER TABLE `odvc6_template_styles`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `odvc6_ucm_base`
--
ALTER TABLE `odvc6_ucm_base`
...
--
-- Indices de la tabla `odvc6_ucm_content`
--
ALTER TABLE `odvc6_ucm_content`
...
--
-- Indices de la tabla `odvc6_ucm_history`
--
ALTER TABLE `odvc6_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indices de la tabla `odvc6_updates`
--
ALTER TABLE `odvc6_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indices de la tabla `odvc6_update_sites`
--
ALTER TABLE `odvc6_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indices de la tabla `odvc6_update_sites_extensions`
--
ALTER TABLE `odvc6_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indices de la tabla `odvc6_usergroups`
--
ALTER TABLE `odvc6_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `odvc6_users`
--
ALTER TABLE `odvc6_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `odvc6_user_keys`
--
ALTER TABLE `odvc6_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Indices de la tabla `odvc6_user_notes`
--
ALTER TABLE `odvc6_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indices de la tabla `odvc6_user_profiles`
--
ALTER TABLE `odvc6_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indices de la tabla `odvc6_user_usergroup_map`
--
ALTER TABLE `odvc6_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indices de la tabla `odvc6_viewlevels`
--
ALTER TABLE `odvc6_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de la tabla `odvc6_action_logs`
--
ALTER TABLE `odvc6_action_logs`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `odvc6_action_logs_extensions`
--
ALTER TABLE `odvc6_action_logs_extensions`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT de la tabla `odvc6_action_log_config`
--
ALTER TABLE `odvc6_action_log_config`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT de la tabla `odvc6_assets`
--
ALTER TABLE `odvc6_assets`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=60;
--
-- AUTO_INCREMENT de la tabla `odvc6_banners`
--
ALTER TABLE `odvc6_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_banner_clients`
--
ALTER TABLE `odvc6_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_categories`
--
ALTER TABLE `odvc6_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT de la tabla `odvc6_contact_details`
--
ALTER TABLE `odvc6_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_content`
--
ALTER TABLE `odvc6_content`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_content_types`
--
ALTER TABLE `odvc6_content_types`
  MODIFY `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT de la tabla `odvc6_extensions`
--
ALTER TABLE `odvc6_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT de la tabla `odvc6_fields`
--
ALTER TABLE `odvc6_fields`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_fields_groups`
--
ALTER TABLE `odvc6_fields_groups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_finder_filters`
--
ALTER TABLE `odvc6_finder_filters`
  MODIFY `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_finder_links`
--
ALTER TABLE `odvc6_finder_links`
  MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_finder_taxonomy`
--
ALTER TABLE `odvc6_finder_taxonomy`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `odvc6_finder_terms`
--
ALTER TABLE `odvc6_finder_terms`
  MODIFY `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_finder_types`
--
ALTER TABLE `odvc6_finder_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_languages`
--
ALTER TABLE `odvc6_languages`
  MODIFY `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `odvc6_menu`
--
ALTER TABLE `odvc6_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=102;
--
-- AUTO_INCREMENT de la tabla `odvc6_menu_types`
--
ALTER TABLE `odvc6_menu_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `odvc6_messages`
--
ALTER TABLE `odvc6_messages`
  MODIFY `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_modules`
--
ALTER TABLE `odvc6_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=90;
--
-- AUTO_INCREMENT de la tabla `odvc6_newsfeeds`
--
ALTER TABLE `odvc6_newsfeeds`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_overrider`
--
ALTER TABLE `odvc6_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT de la tabla `odvc6_postinstall_messages`
--
ALTER TABLE `odvc6_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT de la tabla `odvc6_privacy_consents`
--
ALTER TABLE `odvc6_privacy_consents`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_privacy_requests`
--
ALTER TABLE `odvc6_privacy_requests`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_redirect_links`
--
ALTER TABLE `odvc6_redirect_links`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_tags`
--
ALTER TABLE `odvc6_tags`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `odvc6_template_styles`
--
ALTER TABLE `odvc6_template_styles`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de la tabla `odvc6_ucm_content`
--
ALTER TABLE `odvc6_ucm_content`
  MODIFY `core_content_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_ucm_history`
--
ALTER TABLE `odvc6_ucm_history`
  MODIFY `version_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_updates`
--
ALTER TABLE `odvc6_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=78;
--
-- AUTO_INCREMENT de la tabla `odvc6_update_sites`
--
ALTER TABLE `odvc6_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `odvc6_usergroups`
--
ALTER TABLE `odvc6_usergroups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT de la tabla `odvc6_users`
--
ALTER TABLE `odvc6_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=843;
--
-- AUTO_INCREMENT de la tabla `odvc6_user_keys`
--
ALTER TABLE `odvc6_user_keys`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_user_notes`
--
ALTER TABLE `odvc6_user_notes`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `odvc6_viewlevels`
--
ALTER TABLE `odvc6_viewlevels`
